      ...
      <div className="shadow-md p-10 mb-16">
        ...
        <details>
          ...
          <div>
            ...
            />
            <p className="text-xl my-4 underline">Solución</p>
            <p>La figura encima del cuadrado está compuesta por círculos, cada uno con un diámetro del mismo tamaño de la mitad del lado del cuadrado, por lo que podemos deducir que cada lado del cuadrado es de <i>6 cms.</i></p>
            ...
            <p><i>∴</i> el valor del área sombreada es la misma que el valor del área del cuadrado, esta sería de: <i className="text-green-600">6 * 6 = 36 cm²</i></p>
          </div>
        </details>
      </div>
